...
def create_parser():
    parser = argparse.ArgumentParser(description='naive swapping analysis')
    parser.add_argument('-o', '--output_file',
                        default='swap_errors/naive_swapping/swap_{}.pkl',
                        type=str,
...
if __name__ == '__main__':
    ...
    for k, d_dict in sessions_d1.items():
        out_cu = swan.naive_swapping(d_dict, use_cue=False,
    ...
    for k, d_dict in sessions_d2.items():
        out = swan.naive_swapping(d_dict,
                                  swap_decider=swap_decider,
                                  corr_decider=corr_decider,
                                  kernel=args.forget_kernel,
                                  col_cent=args.col_cent,
